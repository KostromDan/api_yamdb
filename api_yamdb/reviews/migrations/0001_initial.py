# Generated by Django 2.2.16 on 2022-06-23 21:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(related_name='assigned_genre',
                                                 to='reviews.Genre')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(
                    choices=[('USR', 'user'), ('MOD', 'moderator'),
                             ('ADM', 'admin')], default='USR', max_length=3,
                    verbose_name='Роль')),
                (
